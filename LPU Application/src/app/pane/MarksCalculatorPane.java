...
public class MarksCalculatorPane {
        ...
        public MarksCalculatorPane(){
            ...
            marksCalculatorPane.getChildren().addAll(hamburger_button,b1,b2,b3,b4,
                    operator);
        ...
        public static void show(){
            marksCalculatorPane.toFront();
            TranslateTransition any_pane_show=new TranslateTransition(Duration.millis(400),marksCalculatorPane);
